...
// Configure API base URL with fallbacks
...
const medicalApi = axios.create({
  baseURL: API_URL,
  timeout: 120000, // 2 minutes for large DICOM files
  headers: {
...
export const analyzeImage = async (formData, clinicalContext = {}) => {
  try {
    ...
    // Enhanced logging for medical imaging
    ...
    // Enhanced medical imaging error handling
